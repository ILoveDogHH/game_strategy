...
public enum JLoggerWriter {
	...
	private Logger cronLogger = LogManager.getLogger("cronLogger");
	private Logger fixLogger = LogManager.getLogger("fixLogger");

	private JLoggerWriter() {
	}
	 ...
	 * @param msg
	 */
	public void fixInfo(String msg, Object... args) {
		fixLogger.info(msg, args);
	}
	 ...
	 * @param e
	 */
	public void fixError(String msg, Throwable e) {
		fixLogger.error(msg, e);
	}
	...
	public void dayGameLog(String path, String file, String msg, Object... args) {
		GameLoggerFactory.getDayLogger(path, file).info(msg, args);
	}
	...
	public void hourGameLog(String path, String file, String msg, Object... args) {
		GameLoggerFactory.getHourLogger(path, file).info(msg, args);
	}
	...
	public void stopLogger(GameLoggerType type, String fileName) {
		GameLoggerFactory.stop(type, fileName);
	}
