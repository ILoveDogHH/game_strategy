...
public class JLogger {
     ...
     * @param msg
     */
	public static void fixInfo(String msg, Object... args) {
		JLoggerWriter.INSTANCE.fixInfo(msg, args);
    }
     ...
     * @param e
     */
    public static void fixError(String msg, Throwable e) {
		JLoggerWriter.INSTANCE.fixError(msg, e);
    }
	...
	public static void stopDayLogger(String filename) {
		JLoggerWriter.INSTANCE.stopLogger(GameLoggerType.DAY, filename);
	}

	public static void stopHourLogger(String filename) {
		JLoggerWriter.INSTANCE.stopLogger(GameLoggerType.HOUR, filename);
	}

	public static void stopCustomCronLogger(String filename) {
		JLoggerWriter.INSTANCE.stopLogger(GameLoggerType.CUSTOM_CRON, filename);
	}
}
